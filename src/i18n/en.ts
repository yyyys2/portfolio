export const en = {
  ...
  hero: {
    title: "I build UI with a clear understanding of the service.",
    desc: "Based on hands-on experience in real service environments, I build UI that runs reliably and remains maintainable over time.",
    keyword: "Service-Driven Frontend",
  ...
  modal: {
    ...
    reliabilityOps: "Operational Reliability",
    result: "Impact Delivered",
    stack: "Stack",
  },
} as const
